...
class AutoFullLeft : LinearOpMode() {
    override fun runOpMode() {
        ...
        val trajectory1 = robot.drive.trajectorySequenceBuilder()
            .splineToConstantHeading(Vector2d(3.0, 2.5), Math.toRadians(0.0))
            .splineToConstantHeading(Vector2d(45.0, 4.5), Math.toRadians(0.0))
            .splineToSplineHeading(Pose2d(55.8, -5.75, Math.toRadians(-60.0)), Math.toRadians(-40.0))
            .build()

        val trajectory2 = robot.drive.trajectoryBuilder(trajectory1.end(), true)
            .splineToSplineHeading(Pose2d(53.0, 11.0, Math.toRadians(-90.0)), Math.toRadians(80.0))
            .splineToConstantHeading(Vector2d(53.0, 32.75), Math.toRadians(90.0))
            .build()

        val trajectory3 = robot.drive.trajectoryBuilder(trajectory2.end())
            .splineToSplineHeading(Pose2d(56.5, -3.0, Math.toRadians(-70.0)), Math.toRadians(-80.0))
            .build()

        val trajectory4 = robot.drive.trajectoryBuilder(trajectory3.end(), true)
            .splineToSplineHeading(Pose2d(53.0, 11.0, Math.toRadians(-90.0)), Math.toRadians(80.0))
            .splineToConstantHeading(Vector2d(53.0, 33.0), Math.toRadians(90.0))
            .build()
        ...
        val parkLeftTrajectory = robot.drive.trajectoryBuilder(trajectory5.end(), true)
            ...
            .splineToConstantHeading(Vector2d(55.0, 34.0), Math.toRadians(90.0))
            .build()
        ...
        val parkRightTrajectory = robot.drive.trajectoryBuilder(parkCenterTrajectory.end())
            .splineToSplineHeading(Pose2d(60.0, -11.0, Math.toRadians(-90.0)), Math.toRadians(-90.0))
            .build()
                ...
                ParallelCommandGroup(
                    when (parkingLocation) {
                        ...
                        ParkingLocation.RIGHT -> {
                            SequentialCommandGroup(
                                FollowTrajectoryCommand(robot.drive, parkCenterTrajectory),
                                FollowTrajectoryCommand(robot.drive, parkRightTrajectory)
                            )
                        }
                    },
                    WaitCommand(500).andThen(ParallelCommandGroup(
                        LiftPositionCommand(robot.lift, LiftPositionCommand.Position.GROUND),
                        // PivotPositionCommand(robot.pivot, PivotPositionCommand.Position.FORWARD),
                    ))
                ),
